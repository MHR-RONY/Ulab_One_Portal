...
import {
	...
	CalendarDays, Download, MessageSquare, BarChart3, Sparkles, Clock
} from "lucide-react";
...
const ComingSoonOverlay = () => (
	<div className="fixed inset-0 md:left-64 z-50 flex items-center justify-center">
		{/* Backdrop blur + dim — fixed so it always covers full page */}
		...
		>
			...
			>
				...
				<p className="text-sm text-muted-foreground leading-relaxed">
					The <span className="font-semibold text-primary">Analytics</span> module is being
					powered up with live data. Check back soon!
				</p>
			</motion.div>
			...
			>
				<div className="flex items-center gap-2 mb-2">
					...
					<span className="ml-auto text-xs font-black text-primary">72%</span>
				</div>
			...
			>
				{["Live GPA tracking", "Attendance insights", "Engagement heatmap"].map((f) => (
