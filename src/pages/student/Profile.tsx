						...
						{loading ? (
							<div className="animate-pulse space-y-8">
								...
								<div className="bg-card rounded-xl p-6 md:p-8 border border-border shadow-sm flex flex-col md:flex-row gap-6 md:gap-8 items-center">
									<div className="w-28 h-28 md:w-32 md:h-32 rounded-full bg-muted flex-shrink-0" />
									...
									<div className="h-9 w-28 bg-muted rounded-lg flex-shrink-0" />
								</div>
									...
									<div className="lg:col-span-2 space-y-6">
										<div className="bg-card rounded-xl p-6 border border-border shadow-sm space-y-4">
											...
											{Array.from({ length: 3 }).map((_, i) => (
												<div key={i} className="p-4 rounded-xl border border-border bg-secondary/30 flex gap-4">
										...
										<div className="bg-card rounded-xl p-6 border border-border shadow-sm h-40" />
									</div>
								</div>
							</div>
						) : error ? (
