		...
		<div className="flex-1 flex flex-col min-w-0 overflow-hidden">
			...
			<main className="flex-1 overflow-y-auto" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
				<div className={`${isMobile ? "p-4" : "p-8"} max-w-6xl mx-auto`}>
					{loading ? (
						<div className={`grid ${isMobile ? "grid-cols-1" : "grid-cols-12"} gap-6 animate-pulse`}>
							<div className={`${isMobile ? "" : "col-span-8"} space-y-6`}>
								...
								<div className="bg-card rounded-xl p-6 md:p-8 border border-border shadow-sm space-y-6">
									...
									<div className={`flex ${isMobile ? "flex-col items-center" : "flex-row"} gap-6`}>
							...
							{!isMobile && (
								<div className="col-span-4 space-y-6">
									<div className="bg-card rounded-xl p-6 border border-border shadow-sm h-48" />
									<div className="bg-card rounded-xl p-6 border border-border shadow-sm h-32" />
								</div>
							)}
						</div>
					) : (
