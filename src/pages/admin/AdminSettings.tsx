							...
							<div className="flex gap-8 whitespace-nowrap min-w-max">
								{tabs.map((tab) => (
									<button
										...
										className={`pb-4 font-bold flex items-center gap-2 text-sm transition-colors ${activeTab === tab.label
												...
												<div>
													...
													<div className="grid grid-cols-3 gap-3">
														{[
															...
															<button
																key={theme.label}
																className={`flex flex-col items-center gap-2 p-4 rounded-xl border-2 transition-all ${theme.active
