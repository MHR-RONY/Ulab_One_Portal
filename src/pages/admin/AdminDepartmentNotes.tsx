							...
							<div className="flex items-center gap-2 overflow-x-auto w-full md:w-auto">
								...
								{deptFilters.map((f) => (
									<button
										...
										className={`px-4 py-1.5 rounded-full text-xs font-bold transition-all whitespace-nowrap ${activeDeptFilter === f.toLowerCase()
							...
							<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
								{dept.courses.map((course, idx) => (
									<div
										...
										className={`rounded-2xl p-5 transition-all relative overflow-hidden group cursor-pointer ${selectedCourse === idx
									...
									>
										<div className="flex justify-between items-start mb-4">
											<div>
												<span className={`text-[10px] font-black uppercase tracking-widest px-2 py-0.5 rounded ${selectedCourse === idx
										...
										<button className={`w-full mt-5 py-2.5 text-xs font-bold rounded-xl transition-all ${selectedCourse === idx
